...
import { GuideStatsType, useDashboardContext } from "../../../context/DashboardContext";
...
const colors=[
  {destinationName:"Incachaca",color:"from-fuchsia-300/80 to-fuchsia-400/80 dark:from-fuchsia-500 dark:to-fuchsia-700"},
  {destinationName:"Salar de Uyuni",color:"from-violet-300 to-violet-400 dark:from-violet-500 dark:to-violet-700"},
  {destinationName:"Toro Toro",color:"from-blue-300 to-blue-400 dark:from-blue-500 dark:to-blue-700"},
  {destinationName:"Villa Tunari",color:"from-sky-300 to-sky-400 dark:from-sky-500 dark:to-sky-700"},
  {destinationName:"Incallajta",color:"from-orange-200 to-orange-300 dark:from-amber-500 dark:to-amber-700"},
]
...
const BarChartThinBreakdown:React.FC<BarChartThinBreakdownProps> = ({data}) => {
  ...
  const addColorToData = (data:GuideStatsType)=>{
    ...
    for (const destination of destinationswithColor) {
      const newDataElement = {
        ...
        color: colors.find((color)=>color.destinationName===destination.destinationName)?.color,
        img: data.guideImage
    };

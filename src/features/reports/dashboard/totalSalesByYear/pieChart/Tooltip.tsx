...
const Tooltip: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // memo para no recrear el objeto en cada render
...
/* -------------------------------------------------------------------------------------------------
 * TooltipContent (FIX: medir en useLayoutEffect)
 * -----------------------------------------------------------------------------------------------*/
...
>((props) => {
  ...
  // ✅ Detecta mobile sin usar window en render
  React.useEffect(() => {
  ...
  // ✅ Calcula posición fuera del render; aquí sí se puede leer tooltipRef.current

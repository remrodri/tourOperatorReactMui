...
const Tooltip: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // memo para no recrear el objeto value en cada render
...
/* -------------------------------------------------------------------------------------------------
 * TooltipContent (FIX: NO leer ref.current en render)
 * -----------------------------------------------------------------------------------------------*/
...
>((props) => {
  ...
  // ✅ mobile detection sin usar window en render
  React.useEffect(() => {
  ...
  // ✅ calcular posición fuera del render; aquí sí se puede leer tooltipRef.current [1](https://react.dev/reference/eslint-plugin-react-hooks/lints/refs)
